  ...
  return (
    <div className='flex h-screen items-center justify-center bg-slate-800'>
      <form className='border border-white px-6 py-2 rounded-md'  onSubmit={handleSubmit(onSubmit)} >
        ...
        <h2 className='text-white text-2xl'>Signup</h2>
        <br/>
        {/* fullname */}
...
<div className='text-white flex justify-evenly py-2'>
    <p>Have a account? <Link to="/login" className='text:blue underline cursor-pointer'>Login</Link></p>
    <input type="submit" value="Signup" className='text:white bg-green-500 rounded-md cursor-pointer px-2 py-1'/>
